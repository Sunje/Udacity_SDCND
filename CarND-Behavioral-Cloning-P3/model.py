    ...
    while 1: # Loop forever so the generator never terminates
        ...
        for offset in range(0, num_samples, batch_size):
            ...
            for batch_sample in batch_samples:
                ...
                # center_image = cv2.imread('./data2/IMG/'+batch_sample[0].split('/')[-1])
                # left_image = cv2.imread('./data2/IMG/'+batch_sample[1].split('/')[-1])
                # right_image = cv2.imread('./data2/IMG/'+batch_sample[2].split('/')[-1])
            ...
            for image, measurement in list(zip(images,angles)):
